<template>
    <div class="upload-box" :class="'limit' + props.limit">
        <el-upload v-if="props.type == 'text'" v-model:file-list="defData.uploadList"
            :class="{ 'hide-upload': defData.hideUpload, 'upload-text': true }" action="/" list-type="text" :limit="props.limit"
            :on-change="onImgChange" :auto-upload="false" :accept="props.accept"
