        ...
        <el-scrollbar ref="scrollbarRef" @wheel.prevent="onHandleScroll">
            <ul ref="tagsUlRef" class="layout-navbars-tagsView-ul " :class="setTagsStyle">
                <li v-for="(v, k) in state.tagsViewList" :key="k" :ref="
                    ...
                    <i v-if="isActive(v)" class=" layout-navbars-tagsView-ul-li-iconfont"></i>
...
import {setTagsViewNameI18n,isMobile} from '@/utils/other';
...
const tagsViewMoveToCurrentTag = () => {
    nextTick(() => {
        ...
        // 当前滚动条的值
        let scrollRefs = scrollbarRef.value?.wrapRef as HTMLDivElement;
...
onBeforeMount(() => {
    ...
    onTagsViewClickBus.on((param) => {
        let dat: any = Object.assign({}, { contextMenuClickId: param, ...route })
