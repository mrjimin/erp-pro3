    ...
    <div class="login-container">
        ...
        <div class="login-content">
            <div class="login-content-main">
                <h4 class="login-content-title">{{ getThemeConfig.globalTitle }}后台登录</h4>
                <div v-if="!isScan">
                    <el-tabs v-if="0" v-model="tabsActiveName">
                ...
                <!-- <div class="login-content-main-scan" @click="isScan = !isScan">
                    <i class="iconfont" :class="isScan ? 'icon-computer1' : 'icon-barcode-qr'"></i>
...
import Mobile from '@/views/login/components/mobile.vue';
...
.login-container {
    ...
    .login-icon-group {
        ...
        &::before {
            ...
            overflow: hidden;
            height: 80%;
            mask-image: var(--mask-image-bottom);
            -webkit-mask-image: var(--mask-image-bottom);
        ...
        &::after {
            ...
            right: 0;
            top: 0;
            mask-image: var(--mask-image-top);
            -webkit-mask-image: var(--mask-image-top);
            background: var(--el-color-primary-light-5);
            transition: all 0.3s ease;
