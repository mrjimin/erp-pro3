<template>
    <el-dialog v-model="defData.visible" draggable :title="'修改' + defData.typeName" width="680px">
            ...
            <el-row>
                ...
                <el-col :xs="24" :sm="13" :md="13" :lg="13" :xl="13" class="mb20">
                    <el-form-item label="地区" prop="city">
                        <el-cascader v-model="form.data.city" :options="regionData" filterable clearable
                            @change="chooseCity">
                        </el-cascader>
                    </el-form-item>
                </el-col>
